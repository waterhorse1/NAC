...
class meta_solver_with_invariant_small(nn.Module):
    def __init__(self):
        super().__init__()
...
class meta_solver_with_invariant_large(nn.Module):
    def __init__(self):
        super().__init__()
...
class meta_solver_gru(nn.Module):
    def __init__(self):
        ...
        self.final = nn.Sequential(nn.Linear(128*2,128), nn.ReLU(), nn.Linear(128,128), nn.ReLU(), nn.Linear(128,1))
