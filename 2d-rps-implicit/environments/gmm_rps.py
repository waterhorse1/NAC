...
class TorchPop_rps:
    ...
    def psro_popn_update(self, meta_nash, train_iters, train_lr, norm_break_val, implicit=False):
        if implicit == False:
            self.add_agent()
    ...
    def get_exploitability(self, meta_nash, training_iters, norm_break_val, lr=1.0, test=False, implicit=False):
